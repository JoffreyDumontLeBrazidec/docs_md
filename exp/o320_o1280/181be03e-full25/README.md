...
canonical_repo_source: /etc/ecmwf/nfs/dh2_home_a/ecm5702/dev/docs/epics/o320_o1280/in-progress/20260421_181be03e_200k_o320_o1280_eval.md
...
Status: completed (sigma pending)
Owner: ecm5702
...
## What this is
This room is the durable `o320 -> o1280` surface for the `181be03e` family at 200 000 training steps. The full25 evaluation package (predictions, local plots, spectra, TC contours, TC PDF densities, surface loss) is complete and the run root has been finalized into the lean PDF bundle layout. Sigma eval is still pending via a CPU fallback.
...
| sigma | `pending` | CPU fallback job `50035119` |
...
- Sigma eval is the only remaining pillar; AG-side 4-GPU retries exhausted, CPU fallback in progress.
